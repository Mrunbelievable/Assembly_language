...
decodedLength_input: .asciiz "sx*j24qyyy*g6"
...
encodedLength_input: .asciiz "AAAAAAAAAAAAAAAAAAAAAA"

# encodeRun
encodeRun_header: .asciiz "\n\n********* encodeRun *********\n"
encodeRun_letter: .ascii "e"
.align 2
encodeRun_runLength: .word 6
...
runLengthEncode_runFlag: .ascii "z"

# editDistance
editDistance_header: .asciiz "\n\n********* editDistance *********\n"
editDistance_input_str1: .asciiz ""
editDistance_input_str2: .asciiz "1"
.align 2
editDistance_m: .word 0
editDistance_n: .word 1
